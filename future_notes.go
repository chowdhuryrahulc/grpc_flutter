...
* INTERN JOB1(❌ Solved for now): calculate the size of the outgoing grpc message
...
todo Why was the socket not alive after some seconds in flutter side?
todo Credentials for secure grpc connection
